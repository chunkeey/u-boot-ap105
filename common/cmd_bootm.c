...
#else
# define SHOW_BOOT_PROGRESS(arg)	if(arg<0) \
									{	\
									   	ar7100_reg_rmw_clear(AR7100_GPIO_OUT, (1 << 0));		\
									   	ar7100_reg_rmw_set(AR7100_GPIO_OUT, (1 << 2));			\
									}
#endif
...
int do_bootm (cmd_tbl_t *cmdtp, int flag, int argc, char *argv[])
{
	...
	ar7100_reg_rmw_set(AR7100_GPIO_OUT, (1 << 0));	//turn off status led
	udelay(100*1000);

	ar7100_reg_rmw_clear(AR7100_GPIO_OUT, (1 << 2));	//turn off status led
	...
	ar7100_reg_rmw_set(AR7100_GPIO_OUT, (1 << 2));	//turn on status led
...
# error Unknown CPU type
	...
	SHOW_BOOT_PROGRESS (7);
	udelay(500*1000);
	ar7100_reg_rmw_set(AR7100_GPIO_OUT, (1 << 2));	//turn off status led
