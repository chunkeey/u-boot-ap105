...
#define CONFIG_BOOTARGS_FL     "console=ttyS0,9600 mtdparts=ar7100-nor0:256k(uboot),128k(env),16000k(firmware)"

#define MTDPARTS_DEFAULT    "mtdparts=ar7100-nor0:256k(uboot),128k(env),16000k(firmware)"
