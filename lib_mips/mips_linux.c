...
#ifdef LIGHT_POWER
#   define AR7100_APB_BASE                 0xB8000000
		     ...
		     ulong addr, ulong * len_ptr, int verify)
{
	...
	ar7100_reg_rmw_set(AR7100_GPIO_OUT, (1 << 2));	//turn on power led
	...
	if (argc >= 3) {
		...
		ar7100_reg_rmw_clear(AR7100_GPIO_OUT, (1 << 2));	//turn on power led
		SHOW_BOOT_PROGRESS (11);
	...
	printf ("\nStarting kernel ...\n\n");
	ar7100_reg_rmw_set(AR7100_GPIO_OUT, (1 << 2));	//turn off power led
